...
namespace Proyecto1.Controllers
{
    ...
    {
       readonly ServicioApiBasico<Cliente> http = new();
        ...
        // GET: ClienteController/Registrar
        ...
        {
            return await http.Crear($"api/cliente", cliente) ? RedirectToAction("Login","Home") : View();
        }
